...
>
    ...
    >
        <div class="flex shrink-0 items-center justify-between border-b border-gray-200 px-4 py-4 sm:px-5 dark:border-gray-700">
            ...
            <button type="button" class="admin-touch-target inline-flex items-center justify-center rounded-lg p-1.5 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800" @click="{{ $name }} = false" aria-label="Close">
