<form method="GET" class="mb-4 flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:flex-row sm:items-center">
    ...
    <select name="status" class="admin-input sm:w-40">
    ...
    <select name="sort" class="admin-input sm:w-36">
    ...
    <select name="direction" class="admin-input sm:w-28">
    ...
    <x-admin.button type="submit" variant="secondary" size="sm">Filters</x-admin.button>
</form>
