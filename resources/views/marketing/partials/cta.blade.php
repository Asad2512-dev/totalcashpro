<section id="get-started" class="scroll-mt-24 bg-[#F8FAFC] py-20 lg:py-28" aria-labelledby="cta-heading">
    <x-container>
        <div
            id="demo"
            class="relative overflow-hidden rounded-[2rem] bg-[#0F172A] px-8 py-16 text-white sm:px-12 lg:px-16"
            data-reveal
        >
            <div class="pointer-events-none absolute inset-0" aria-hidden="true">
                <div class="absolute -left-16 top-0 h-64 w-64 rounded-full bg-[#2563EB]/30 blur-3xl"></div>
                <div class="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-[#10B981]/20 blur-3xl"></div>
            </div>
