    ...
    >
        <x-admin.card class="text-center">
            ...
            <div class="mt-6 grid gap-2">
                <button type="button" class="rounded-xl bg-primary-600 px-4 py-3 text-sm font-semibold text-white hover:bg-primary-700 disabled:opacity-60" x-show="state === 'not_checked_in'" @click="act('clock-in')" :disabled="loading">Clock In</button>
